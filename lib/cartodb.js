...
function CartoDB(params) {
  ...
  this.api_url = this.api_url || resources.api_url.replace(':user', this.user).replace(':url', this.cartodb_url);
  this.request_url = resources.request_url.replace(':user', this.user).replace(':url', this.cartodb_url);
  this.access_url = resources.access_url.replace(':user', this.user).replace(':url', this.cartodb_url);
